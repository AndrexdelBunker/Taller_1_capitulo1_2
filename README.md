...
<img src="https://latex.codecogs.com/svg.image?\bigl(\begin{smallmatrix}b.\end{smallmatrix}\bigr)~\frac{10~J}{C}\\~~~~~~~~~~~V=&space;\frac{W}{Q}\\~~~~~~~~~~~V=&space;\frac{10}{1}~~~~~~~~~~~\\V=&space;10~v" title="\bigl(\begin{smallmatrix}b.\end{smallmatrix}\bigr)~\frac{10~J}{C}\\~~~~~~~~~~~V= \frac{W}{Q}\\~~~~~~~~~~~V= \frac{10}{1}~~~~~~~~~~~\\V= 10~v" />
