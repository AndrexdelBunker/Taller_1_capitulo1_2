...
<img src="https://latex.codecogs.com/svg.image?\bigl(\begin{smallmatrix}a.\end{smallmatrix}\bigr)~\frac{10~J}{C}\\V=&space;\frac{W}{Q}\\V=&space;10~v" title="\bigl(\begin{smallmatrix}a.\end{smallmatrix}\bigr)~\frac{10~J}{C}\\V= \frac{W}{Q}\\V= 10~v" />
