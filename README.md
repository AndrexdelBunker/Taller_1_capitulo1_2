...
<img src="https://latex.codecogs.com/svg.image?\bigl(\begin{smallmatrix}c\end{smallmatrix}.\bigr)~\bigl(\begin{smallmatrix}5,6\times&space;10^{-8}\end{smallmatrix}\bigr)&plus;\bigl(\begin{smallmatrix}4,6\times&space;10^{-9}\end{smallmatrix}\bigr)\\~~~~~~~~~~~~~5,6\times&space;10^{-8}&plus;0,46\times&space;10^{-8}\\~~~~~~~~~~~~~6,06\times&space;10^{-8}" title="\bigl(\begin{smallmatrix}c\end{smallmatrix}.\bigr)~\bigl(\begin{smallmatrix}5,6\times 10^{-8}\end{smallmatrix}\bigr)+\bigl(\begin{smallmatrix}4,6\times 10^{-9}\end{smallmatrix}\bigr)\\~~~~~~~~~~~~~5,6\times 10^{-8}+0,46\times 10^{-8}\\~~~~~~~~~~~~~6,06\times 10^{-8}" />
